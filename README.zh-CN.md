...
15 套共 275 项全绿：unit 32 + service 25 + heal 10 + 截断续写 5 + 图片代理 8 + 浏览器回归 14 + 安全 13 + 文件夹选择器 26 + v0.7.2 布局 20 + v0.7.3 原生观感 12 + v0.7.4 文件夹与导航 51 + v0.8.1 样式与进度条 36 + v0.8.2 按钮与思考折叠 12 + 风格级联 7 + v0.9.0 风格 UI 8。
